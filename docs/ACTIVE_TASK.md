...
`main` (F1-R1 `ed4d3d5` pushed; tree clean; repo-local identity set)
...
- Branch `main`, clean tree, F1-R1 commit `ed4d3d5`, origin in sync.
...
F1-R1: `ed4d3d57dbf2228905e3d570e580d910a7557fe6` (pushed, verified).
F1-R2: none yet.
